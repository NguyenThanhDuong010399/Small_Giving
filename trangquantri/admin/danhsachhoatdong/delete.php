...
if(isset($data->idHoatDong)){
    ...
    $check_post = "SELECT * FROM tblhoatdong WHERE idHoatDong=:post_id";
    ...
    if($check_post_stmt->rowCount() > 0){
        ...
        $delete_post = "DELETE FROM tblhoatdong WHERE idHoatDong=:idHoatDong";
        $delete_post_stmt = $conn->prepare($delete_post);
        $delete_post_stmt->bindValue(':idHoatDong', $data->idHoatDong,PDO::PARAM_INT);
