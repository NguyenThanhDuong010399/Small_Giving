...
if(isset($data->idNguoiDung)){
    ...
    $check_post = "SELECT * FROM tblnguoidung WHERE idNguoiDung=:post_id";
    ...
    if($check_post_stmt->rowCount() > 0){
        ...
        $delete_post = "DELETE FROM tblnguoidung WHERE idNguoiDung=:idNguoiDung";
        $delete_post_stmt = $conn->prepare($delete_post);
        $delete_post_stmt->bindValue(':idNguoiDung', $data->idNguoiDung,PDO::PARAM_INT);
